...
# configs for HRNet8
HRNET_8 = CN()
HRNET_8.FINAL_CONV_KERNEL = 1

HRNET_8.STAGE1 = CN()
HRNET_8.STAGE1.NUM_MODULES = 1
HRNET_8.STAGE1.NUM_BRANCHES = 1
HRNET_8.STAGE1.NUM_BLOCKS = [4]
HRNET_8.STAGE1.NUM_CHANNELS = [32]
HRNET_8.STAGE1.BLOCK = 'BOTTLENECK'
HRNET_8.STAGE1.FUSE_METHOD = 'SUM'

HRNET_8.STAGE2 = CN()
HRNET_8.STAGE2.NUM_MODULES = 1
HRNET_8.STAGE2.NUM_BRANCHES = 2
HRNET_8.STAGE2.NUM_BLOCKS = [4, 4]
HRNET_8.STAGE2.NUM_CHANNELS = [8, 16]
HRNET_8.STAGE2.BLOCK = 'BASIC'
HRNET_8.STAGE2.FUSE_METHOD = 'SUM'

HRNET_8.STAGE3 = CN()
HRNET_8.STAGE3.NUM_MODULES = 4
HRNET_8.STAGE3.NUM_BRANCHES = 3
HRNET_8.STAGE3.NUM_BLOCKS = [4, 4, 4]
HRNET_8.STAGE3.NUM_CHANNELS = [8, 16, 32]
HRNET_8.STAGE3.BLOCK = 'BASIC'
HRNET_8.STAGE3.FUSE_METHOD = 'SUM'

HRNET_8.STAGE4 = CN()
HRNET_8.STAGE4.NUM_MODULES = 3
HRNET_8.STAGE4.NUM_BRANCHES = 4
HRNET_8.STAGE4.NUM_BLOCKS = [4, 4, 4, 4]
HRNET_8.STAGE4.NUM_CHANNELS = [8, 16, 32, 64]
HRNET_8.STAGE4.BLOCK = 'BASIC'
HRNET_8.STAGE4.FUSE_METHOD = 'SUM'
